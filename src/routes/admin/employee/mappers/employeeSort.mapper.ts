...
export const employeeSortMapper = ({
  sortField,
  sortOrder,
}: ISortMapper): Prisma.Enumerable<Prisma.EmployeeOrderByWithAggregationInput> | undefined => {
  switch (sortField) {
    case ESortField.ID:
      return { id: sortOrder };
    ...
    case ESortField.OWNER_ID:
      return { owner_id: sortOrder };
    case ESortField.LOGIN:
      return { login: sortOrder };
    default:
